...
def parse_args():
    ...
    parser.add_argument("--config_label", type=str, default="RaGNNarok_final_IcaRAus_ds",
                        help="The config file name (without .py) to use.")
    parser.add_argument("--checkpoint_path", type=str, default="/home/david/Documents/odometry/submodules/mmwave_model_integrator/scripts/working_dir/RaGNNarok/RaGNNarok_final_IcaRAus_ds.pth",
