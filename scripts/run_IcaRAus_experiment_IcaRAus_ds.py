...
def main():
    ...
    # Resolve dataset path if not provided (fallback to config default)
    # Note: In the original script, it was using config.generated_dataset["generated_dataset_path"]
    # We'll maintain that behavior if dataset_path is None or default.
    dataset_path = args.dataset_path
    if dataset_path == "/home/david/Downloads/IcaRAus_datasets/RaGNNarok_ugv_IcaRAus_ds_wilk_cpsl_north":
         # This is the default from parse_args. 
         # If the user didn't override it, we might want to check the config first.
         pass
