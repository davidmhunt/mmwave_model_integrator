...
def parse_args():
    ...
    parser.add_argument("--config_label", type=str, default="IcaRAus_gnn_final_RaGNNarok_ds",
                        help="The config file name (without .py) to use.")
    parser.add_argument("--dataset_path", type=str, default="/home/david/Downloads/ragnnarok_datasets/IcaRAus_ugv_RaGNNarok_ds_wilk_basement_train",
                        help="Path to the dataset directory.")
    parser.add_argument("--checkpoint_path", type=str, default="/home/david/Documents/odometry/submodules/mmwave_model_integrator/scripts/working_dir/IcaRAus_gnn_IcaRAus_ds/IcaRAus_gnn_RaGNNarok_ds.pth",
